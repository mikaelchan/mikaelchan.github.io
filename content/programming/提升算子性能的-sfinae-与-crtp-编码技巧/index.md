+++
date = '2025-07-15T11:27:25+08:00'
title = '提升算子性能的 SFINAE 与 CRTP 编码技巧'
tags = ['NPU', 'C++', 'Operator']
draft = false
description = '介绍两种 C++ 编码技巧：SFINAE（Substitution Failure Is Not An Error）和 CRTP（Curiously Recurring Template Pattern），它们可以帮助实现高性能的算子。'
+++
...
本文将介绍两种 C++ 编码技巧：SFINAE（Substitution Failure Is Not An Error）和 CRTP（Curiously Recurring Template Pattern），它们可以帮助实现高性能的算子。
<!--more-->
{{<katex>}}
> [!INFO] 实际上由于程序员的水平限制，我仅仅在 flash attention 和卷积中见过类似实践🤭
### 1. 为什么不支持虚函数
